...
/*   Updated: 2024/05/16 12:43:46 by sel-bouy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	img->wa = "./bonus/images/wall.xpm";
	img->fl = "./bonus/images/floor.xpm";
	img->d = "./bonus/images/door.xpm";
	img->o_d = "./bonus/images/open_door.xpm";
	img->co = "./bonus/images/coin.xpm";
	img->pl = "./bonus/images/player.xpm";
	img->en = "./bonus/images/enemy.xpm";
	img->en_r = "./bonus/images/enemy_right.xpm";
	img->en_l = "./bonus/images/enemy_left.xpm";
...
void	norm(t_data *img)
{
	...
	img->ens[0] = mlx_xpm_file_to_image(img->mx, img->en_l, &img->y, &img->x);
	img->ens[1] = mlx_xpm_file_to_image (img->mx, img->en, &img->y, &img->x);
	img->ens[2] = mlx_xpm_file_to_image(img->mx, img->en_r, &img->y, &img->x);
